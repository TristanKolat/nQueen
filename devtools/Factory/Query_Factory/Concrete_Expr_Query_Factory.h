...
public:
    virtual Horizontal_Conflict_Query* create_horizontal_conflict_query(Array<int> &board, int row);
    virtual Diagonal_Conflict_Query* create_diagonal_conflict_query(Array<int> &board, size_t column, int row);
};
